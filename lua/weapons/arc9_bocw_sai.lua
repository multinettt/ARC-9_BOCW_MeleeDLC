...
SWEP.Description = [[Dual wield melee. Famous for its use in the Japanese martial art of Ninjutsu. Lightweight and versatile with fast attacks. 2-hits to kill from the front with 1-hit backstabs.

The Sai is a melee weapon featured in Call of Duty: Black Ops Cold War, Call of Duty: Mobile, and Call of Duty: Black Ops 6.

The Sai was added to Call of Duty: Black Ops Cold War on September 21st, 2021 as part of the Season Five Reloaded update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_sai_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_sai_bocw.mdl"
...
SWEP.CustomizePos = Vector(-1, 19, 6)
...
SWEP.Attachments = {
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_sai_sticker1.mdl",
        CosmeticOnly = true,
    },
}
