...
SWEP.Description = [[Lethal sporting equipment. Lightweight bat with a cork center. Swing for the fences to knock your enemies out of the park.

The Baseball Bat is a melee weapon featured in Call of Duty: Black Ops III, Call of Duty: WWII, Call of Duty: Mobile, Call of Duty: Black Ops Cold War, Call of Duty: Black Ops 6, and making brief appearances in Call of Duty: Black Ops II, Call of Duty: Black Ops 4, Call of Duty: Vanguard, Call of Duty: Modern Warfare II and Call of Duty: Black Ops 7.

The Baseball Bat returns in Call of Duty: Black Ops Cold War. It was added on May 22th, 2021 as part of the Season Three update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_baseballbat_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_baseballbat_bocw.mdl"
...
SWEP.MeleeHitSound = "ARC9_BOCW.BaseballBat_hit"
SWEP.MeleeHitWallSound = "ARC9_BOCW.BaseballBat_impact"
...
SWEP.CustomizeAng = Angle(0, -25, 70)
SWEP.CustomizePos = Vector(-3, 25, 10)
...
SWEP.Attachments = {
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_baseballbat_sticker1.mdl",
        CosmeticOnly = true,
    },
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = "ready",
        EventTable = {
            { s = "ARC9_BOCW.BaseballBat_ready", t = 0 },
        },
    },
    ["bash"] = {
        Source = "melee1",
    ...
    ["enter_inspect"] = {
        Source = "inspect",
        EventTable = {
            { s = "ARC9_BOCW.baseballbat_inspect", t = 0 },
        },
    },
}