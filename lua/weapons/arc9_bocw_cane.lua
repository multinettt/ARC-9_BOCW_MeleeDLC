...
SWEP.Description = [[Lethal walking cane. Where fashion meets function. Adorned with a sterling silver handle, this cane is easy to grip and deadly when swung.

The Cane is a melee weapon featured in Call of Duty: Black Ops Cold War. It was added as part of the Season Five update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_cane_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_cane_bocw.mdl"
...
SWEP.CustomizeAng = Angle(0, 45, 12)
SWEP.CustomizePos = Vector(1, 22, -10)
...
SWEP.Attachments = {
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_cane_sticker1.mdl",
        CosmeticOnly = true,
    },
}
