...
SWEP.Description = [[Two-handed melee. Reap a bountiful harvest by cutting down all who stand in your path. Quick swinging with a wide arc for deadly efficiency.

The Scythe is a melee weapon featured in Call of Duty: Black Ops Cold War and Call of Duty: Mobile.

The Scythe was added to Call of Duty: Black Ops Cold War on the August 12th, 2022 update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_scythe_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_scythe_bocw.mdl"
...
SWEP.Attachments = {
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_scythe_sticker1.mdl",
        CosmeticOnly = true,
    },
}
...
SWEP.Animations = {
    ...
    ["enter_inspect"] = {
        Source = "inspect",
        EventTable = {
            { s = "ARC9_BOCW.Scythe_inspect", t = 0 },
        },
    },
}